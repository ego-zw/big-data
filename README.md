...
## 项目摘要
- 您好我是XX，我现在正在做一个大数据产品。项目目的是解决药品价格不合理的问题。通过对药品价格和药品药理的数据分析，最后再结合民意调查来判断药品价格是否合理。
我们会有几种解决方案，
其一种是向政府机构提出建议。建议政府将价格不合理药物列入医保名单，以国家单位去和药品生产商砍价，这样会起到显著的效果。另外，政府还能帮助患者缓解医疗支出的压力。
第二种是通过药物药理数据分析，找到具有相同药理的替代品药物。首选使用性价比最高的药物，减少使用类似价格高昂的“进口药物”
我们会以平台或者网站的形式进行开展
预期成果是可以改善社会医疗拼价格的不良风气，为社会医疗资源的平均作出贡献，缓解患者家庭的资金压力。同时为国企良心药物企业做出支持。
